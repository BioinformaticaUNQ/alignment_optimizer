...
Welcome to ``Final-Proyect-Alignment`` contributor's guide.
...
If you experience bugs or general issues with ``Final-Proyect-Alignment``, please have a look
...
You can help improve ``Final-Proyect-Alignment`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Final-Proyect-Alignment`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Final-Proyect-Alignment``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Final-Proyect-Alignment python=3 six virtualenv pytest pytest-cov
    conda activate Final-Proyect-Alignment
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Final-Proyect-Alignment.git
    cd Final-Proyect-Alignment
...
#. Install |pre-commit|_::
   ...
   ``Final-Proyect-Alignment`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Final-Proyect-Alignment
.. _issue tracker: https://github.com/<USERNAME>/Final-Proyect-Alignment/issues
.. <-- end -->
